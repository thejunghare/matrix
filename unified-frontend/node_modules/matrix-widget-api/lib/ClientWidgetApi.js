...
var ClientWidgetApi = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(ClientWidgetApi, [{
    ...
    value: function handleSendEvent(request) {
      ...
      if (isStickyEvent && !this.hasCapability(_Capabilities.MatrixCapabilities.MSC4354SendStickyEvent)) {
        return this.transport.reply(request, {
          error: {
            message: "Missing capability for ".concat(_Capabilities.MatrixCapabilities.MSC4354SendStickyEvent)
          }
        });
      }
